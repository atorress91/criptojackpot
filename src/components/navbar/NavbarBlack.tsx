...
const NavbarBlack = () => {
    ...
    return (
        <header className={`header-section-v1 custom-fixed header-position ${scrollHeight > 50 ? "animated fadeInDown header-fixed" : ""}`}>
            {/* desktop header */}
                    ...
                    <nav className="navbar-custom">
                        <div className="d-flex align-items-center justify-content-between">
                            ...
                            <div className="d-flex gap-6">
                                <button className={`navbar-toggle-btn d-block d-xl-none ${isNavOpen ? "open" : ""}`} type="button" onClick={handleNavToggle}>
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                ...
                                <ul className="custom-nav d-xl-flex d-grid gap-4 gap-xl-5 gap-xxl-10">
                                    ...
                                    {navbarData.map(({ id, menuTitle, path, menuItems }) => {
                                        ...
                                        return menuItems ? (
                                            ...
                                            <li key={`black-nav-menu-title-${id}`} className={`menu-item position-relative ${pathName === path ? "active" : ""}`}>
