                ...
                <div className="row g-xl-4 g-3 align-items-center justify-content-between mb-xxl-12 mb-xl-10 mb-8">
                    ...
                    <div className="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                        <div className="browse-more" data-aos="zoom-in-up" data-aos-duration="2000">
                            <Link href="blog-details" className="cmn__collection radius-circle s1-bg d-center position-relative ms-lg-auto">
                <span className="cmn-cont-box text-center position-relative">
                  <span className="icon mb-1">
                    <ArrowUpRight className="n0-clr fs-three" />
                  </span>
            ...
            <div className="container">
                <div className="row g-6">
                    {blogCardsData?.map((blogCard, index) => (
                        <BlogCard key={`faq-${index}`} imageUrl={blogCard.imageUrl} date={blogCard.date} title={blogCard.title} description={blogCard.description} link={blogCard.link} />
                    ))}
