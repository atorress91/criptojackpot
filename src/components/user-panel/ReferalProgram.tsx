        ...
        <div className="table-responsive">
          <table className="table">
            <thead>
              <tr>
                <th>
                  <span className="n4-clr fs20 fw_700">{t("REFERRAL_PROGRAM.table.date")}</span>
                </th>
                <th>
                  <span className="n4-clr fs20 fw_700">{t("REFERRAL_PROGRAM.table.level")}</span>
                </th>
                <th>
                  <span className="n4-clr fs20 fw_700">{t("REFERRAL_PROGRAM.table.username")}</span>
                </th>
                <th>
                  <span className="n4-clr fs20 fw_700">{t("REFERRAL_PROGRAM.table.email")}</span>
                </th>
              </tr>
            </thead>
            <tbody>
